...
public record DashboardRecentVisitResponse(
    ...
    @Schema(description = "Entry time of the visit", example = "2024-06-01T08:30:00")
        LocalDateTime entryTime,
    @Schema(description = "Exit time of the visit", example = "2024-06-01T10:30:00")
        LocalDateTime exitTime,
    @Schema(description = "Status of the visit", example = "Sees")
        VisitStatus status, // "Sees", "Väljas", "Ootel"
    @Schema(
